...
<div key={show._id} className="w-55 rounded-lg overflow-hidden h-full pb-3 bg-primary/10 border border-amber-500/35 hover:-translate-y-1 transition duration-300">
...
<StarIcon className="w-4 h-4 text-[color:#fa2c5f] fill-[color:#fa2c5f]" />
