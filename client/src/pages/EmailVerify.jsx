...
const EmailVerify = () => {
  ...
  return (
    <div className="flex items-center bg-[url('/astrobg.jpg')] bg-cover bg-center justify-center min-h-screen bg-gradient-to-br">
      <img onClick={() => navigate("/")} src={assets.logo} alt="logo" className="absolute left-5 sm:left-15 top-5 w-40 max-md:w-32 cursor-pointer"
      />
      <form
        onSubmit={onSubmitHandler}
        className="border-2 p-10 rounded-lg shadow-[0_0_20px_rgba(255,1162,0,0.3)] w-full sm:w-96 text-indigo-300 text-sm"
      >
