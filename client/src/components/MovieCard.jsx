...
const {image_base_url} = useMovieContext();
...
className='px-4 py-2 text-xs bg-amber-600 hover:bg-amber-700 transition rounded-full font-medium cursor-pointer'>
    Buy Tickets
</button>

<p className='flex items-center gap-1 text-sm text-gray-400 mt-1 pr-1'>
<StarIcon className="w-4 h-4 text-fuchsia-600 fill-fuchsia-600"/>
